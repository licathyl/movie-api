...
let allowedOrigins = [
  "http://localhost:8080",
  "http://localhost:1234",
  "https://myflix-cathyli.netlify.app",
];
...
app.post(
  ...
  // can either use a chain of methods like .not().isEmpty()
  // which means "opposite of isEmpty" in plain english "is not empty"
  // or use .isLength({min: 5})
  // which means minimum value of 5 characters are only allowed
  [
